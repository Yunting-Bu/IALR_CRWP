...
!> ========== Constants ==========
    ...
    complex(c8), parameter :: imgZero = (0.0_c8, 0.0_c8)
...
!> ========== Global Parameters ==========
    ...
    type :: Vabs_class
        integer :: nZasy, nZlr, nrint, nZint 
        real(f8) :: Casy, Clr, Cr, Cint 
        real(f8) :: Zasy_range, Zlr_range, rabs_range, Zint_range
    end type Vabs_class
...
!> FBR to DVR transformation matrix
    real(f8), allocatable :: int_YMat(:,:), asy_YMat(:,:)
!> Z
...
!> ========== Namelists ==========
    ...
    namelist /task/ nChannel, IF_inelastic, inePos, IDflux, fluxPos, &
