      subroutine pot0(npes,v,bond)
c	      bond(1)=r_ab, bond(2)=r_bc, bond(3)=r_ac
      implicit none
      ...
      if (npes .ne. 1) stop 'Wrong! pot0'

      r(1)=bond(1)
      r(2)=bond(2)
      r(3)=bond(3)
      call bkmp2(r,vev,vd1,-1)
      vev=vev+(4.47809d0+0.27018326d0)/27.2114d0
      v=vev
...
c    add up the various parts of the derivative:
     ...
     .                  dVbnda,dvbndb,dCbnda,dCbndb
      ...
      return
 7400 format('Vba values: ',5(1x,g14.6),/,'Vbb values: ',5(1x,g14.6))
 ...
 7000 format(5x,'    r =',3(1x,f16.10),' icompac = ',i1,/,
     .       5x,'Vtot  = ',f18.12,/,
     .       5x,'Vlon  = ',f18.12,'       Vas   = ',g20.12,/,
     .       5x,'Cal   = ',g20.12,'       Cas   = ',g20.12,/,
     .       5x,'Vbnda = ',g20.12,'       Vbndb = ',g20.12,/,
     .       5x,'Cbnda = ',g20.12,'       Cbndb = ',g20.12)
 7100 format(' dVtot   = ',3(1x,g20.12),/,
     .       ' dVlon   = ',3(1x,g20.12),/,
     .       ' dVas    = ',3(1x,g20.12),/,
     .       ' dVbnda  = ',3(1x,g20.12),/,
     .       ' dVbndb  = ',3(1x,g20.12),/,
     ...
     .       ' dCbnda  = ',3(1x,g20.12),/,
     .       ' dCbndb  = ',3(1x,g20.12))
 7750 format(3(1x,g18.10))
 7751 format(/,3(1x,g18.10))
...
C self-contained version of schwenkes H2 potential
...
c  calculate the derivatives with respect to r(i):
 ...
 7000 format('             r = ',3(1x,f12.6),/,
     ...
     .       '            E3 = ',3(1x,f12.8),/,
     .       '          vlon = ',1x,f12.8)
 7100 format(13x,'q = ',3(1x,e14.6),/,13x,'j = ',3(1x,e14.6))
 7200 format('         dVlon = ',3(1x,g14.6))
 7400 format('from subr.london: ',/,
     .       '  using r',i1,':   Esinglet=',3(1x,f12.8),/,
     .       '         ',1x,'    Etriplet=',3(1x,f12.8))
 7410 format('         sumQ = ',g14.6,'        sumJ = ',g14.6)
 7420 format('         Vlon = ',f12.8,'      rootJt = ',g14.6)
      return
      end
c
...
C   calculate the Vas term first (eq.14 of truhlar/horowitz)
 ...
 7100 format('    from subr.vascal:   Vas  = ',  1x,g14.6, /,
     .       '                        dS   = ',3(1x,g14.6),/,
     .       '                        dVas = ',3(1x,g14.6))
      return
      end
...
c    write out the series explicitly:
	 ...
	 if(ipr.gt.0) then
      ...
      return
 7400 format('subr.Cas:   series = ',g14.6,'     term1 = ',g14.6,/,
     .       '             eterm = ',g14.6,'      Cas  = ',g14.6)
 7500 format('    derivatives: dPr = ',3(1x,g14.6),/,
     .       '                 dT  = ',3(1x,g14.6),/,
     .       '              dterm1 = ',3(1x,g14.6),/,
     .       '              determ = ',3(1x,g14.6),/,
     .       '             dseries = ',3(1x,g14.6),/,
...
c nov 4/90 Vbend coefficients now a,g  Cbend coeffs still c,d
...
cd    end if
 ...
 2010 format(5x,'B1a, B1b, B2, B3 = ',4(1x,g14.6))
 7100 format('    Vbnda = ',g14.6,'     Vbndb = ',g14.6)
 7650 format('    B2 =    ',g14.6,'       B3 =  ',g14.6)
 7700 format('    dB2 =   ',3(1x,g14.6),/,
     .       '    dB3 =   ',6(1x,g14.6))
 7150 format(' k=',i1,'     derivatives: ',/,
     ...
     .       ' dVb5  = ',3(1x,g18.10),/,
     .       ' dVbnd = ',3(1x,g18.10))
 7155 format('  Vb1 = ',g18.10,'  Vb2 = ',g18.10,/,
     .       '  Vb3 = ',g18.10,'  Vb4 = ',g18.10,/,
     .       '  Vb5 = ',g18.10)
 2020 format(5x,'k=',i1,' cb1,cb2,cb3= ',3(1x,g18.10),
     .     /,8x,' cb4,cb5,cb6= ',3(1x,g18.10),
     .     /,8x,' cb7,cb8,cb9= ',3(1x,g18.10))
 2033 format(5x,'sumT = ',g14.6 ,'  cbnds(k) = ',g14.6)
 7152 format('Subr.Cbend:   k=',i1,'     derivatives: ',/,
     ...
     .       '  dCb9  = ',3(1x,g20.12),/,
     .       '  dCbnd = ',3(1x,g20.12))
 7200 format('  dT    = ',3(1x,g20.12),/,
     .       '  dCbnda= ',3(1x,g20.12),/,
     .       '  dCbndb= ',3(1x,g20.12))
 6000 format(' from subr.b1ab:  r=',3(1x,f9.6))
 6010 format('    b1a = ',f16.10,'     b1b = ',f16.10)
 6020 format('    db1a: ',3(1x,e14.6),/,'    db1b: ',3(1x,e14.6))
 7000 format('    dc(j)/dr(i) derivatives: ',/,
     .    8x,3(1x,e14.6),/,8x,3(1x,e14.6),/,8x,3(1x,e14.6))
 7010 format('    ri2-rj2-rk2: ',3(1x,e14.6),/,
     .       '       cosines : ',3(1x,e14.6),/,
     .       '    12c**2 - 3 : ',3(1x,e14.6))
      end
c
